  ...
  return (
    <main className="min-h-screen flex items-center justify-center font-body px-4 phone-lg:px-0" style={{ background: colors.white }}>
      <div className="w-full max-w-xs phone-md:max-w-sm phone-lg:max-w-md mx-auto 
        ...
        <h1 style={{ fontWeight: 700, fontSize: '2rem', textAlign: 'center', marginBottom: '1.5rem' }}>Consent document 2</h1>
        ...
        >
          {saving ? "Saving..." : "Finish and continue to the app"}
        </button>
      </div>
    </main>
  );
...
export default function ConsentStep2Page() {
  return (
    <Suspense fallback={
      <main className="min-h-screen flex items-center justify-center font-body px-4 phone-lg:px-0" style={{ background: colors.white }}>
